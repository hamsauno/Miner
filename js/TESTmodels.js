let jsonData = [];
 ...
 function calculateProfit() {
   ...
   document.getElementById("income_rub").innerText = (dailyIncome * usdtPrice).toFixed(0).toLocaleString('ru-RU');
   document.getElementById("profit").innerText = dailyProfit.toFixed(2);
   document.getElementById("profit_rub").innerText = (dailyProfit * usdtPrice).toFixed(0).toLocaleString('ru-RU');
   document.getElementById("incomeMonth").innerText = (dailyIncome * 30.5).toFixed(2);
   document.getElementById("incomeMonth_rub").innerText = (dailyIncome * 30.5 * usdtPrice).toFixed(0).toLocaleString('ru-RU');
   document.getElementById("incomeYear").innerText = (dailyIncome * 365).toFixed(2);
   document.getElementById("incomeYear_rub").innerText = (dailyIncome * 365 * usdtPrice).toFixed(0).toLocaleString('ru-RU');
   document.getElementById("profitMonth").innerText = monthlyProfit.toFixed(2);
   document.getElementById("profitMonth_rub").innerText = (monthlyProfit * usdtPrice).toFixed(0).toLocaleString('ru-RU');
   document.getElementById("profitYear").innerText = yearlyProfit.toFixed(2);
   document.getElementById("profitYear_rub").innerText = (yearlyProfit * usdtPrice).toFixed(0).toLocaleString('ru-RU');
