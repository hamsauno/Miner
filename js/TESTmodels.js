let jsonData = [];
 ...
 function calculateProfit() {
   ...
   document.getElementById("profit_rub").innerText = (dailyProfit * usdtPrice).toFixed(2);
   document.getElementById("incomeMonth").innerText = (dailyIncome * 30.5).toFixed(2);
   document.getElementById("incomeMonth_rub").innerText = (dailyIncome * 30.5 * usdtPrice).toFixed(2);
   document.getElementById("incomeYear").innerText = (dailyIncome * 365).toFixed(2);
   document.getElementById("incomeYear_rub").innerText = (dailyIncome * 365 * usdtPrice).toFixed(2);
   document.getElementById("profitMonth").innerText = monthlyProfit.toFixed(2);
   document.getElementById("profitMonth_rub").innerText = (monthlyProfit * usdtPrice).toFixed(2);
   document.getElementById("profitYear").innerText = yearlyProfit.toFixed(2);
   document.getElementById("profitYear_rub").innerText = (yearlyProfit * usdtPrice).toFixed(2);
